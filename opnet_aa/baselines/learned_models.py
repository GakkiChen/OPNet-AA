...
class OPNet(AbstractCaterModel):
    ...
    def forward(self, boxes: torch.tensor, track_mat) -> torch.tensor:
#         print('input box shape: ', boxes.shape)
#         print(boxes[0,0,:,:])
#         print('track mat shape: ', track_mat.shape)
#         print(track_mat[0,0,:])
...
#         print('object_to_track_features shape: ', object_to_track_features.shape)
#         print('object_to_track_prediction shape: ', object_to_track_prediction.shape)
#         print('object_to_track_index_probs shape: ', object_to_track_index_probs.shape)
#         print(object_to_track_index_probs[0,0,:])
        object_to_track_index_probs = torch.mul(object_to_track_index_probs, track_mat)
#         print('weighted object_to_track_index_probs shape: ', object_to_track_index_probs.shape)
#         print(object_to_track_index_probs[0,0,:])
#         input("enter")
